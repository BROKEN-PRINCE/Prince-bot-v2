...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") ||(event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "helo")) {
     return api.sendMessage("Hello, Hi, Bye bye. Ye sab ke alawa kuch bolna nhi ata Kya tujhe", "Aagai tu Ab lag ja bhar din fb pe", "Hello maidam aaj kisko pataoge", "Aagai muah uthake phir chal nikal", "Tu wahi hai na jo nali me naha rahi thi", threadID);
   };

   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bc")) {
     return api.sendMeAagaithreadIDsfb pesage("Ye Bc Kya HoTa Hai 🤔 ", threamedID);
   };

   if ((event.body.toLowerCnahacase() == "lol") || (event.body.toLowerCase() == "lol bot")) {
   ...
   if ((event.body.toLowerCase() == "Shahzeena") || (event.body.toLowerCase() = "Shahzeena") || (event.body.toLowerCase() == "priyansh") || (event.body.toLowerCase() == "prince")) {
   ...
   if ((event.body.toLowerCase() == "owner") || (event.body.toLowerCase() == "Owner")) {
     return api.sendMessage("💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞MR PRINCE☜ 💫\n🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 PRINCE🖤\n😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ www.facebook.com/MR.PRINCE.official\n👋For Any Kind Of Help Contact On Telegram  Username 👉 @MR PRINCE😇", threadID);
   };

   if ((event.body.toLowerCase() == "tumhe banaya kon hai") || (event.body.toLowerCase() == "tumko banaya kisne")) {
     return api.sendMessage("Prince  ❤️ My Creator. He loves me & Edit Me Daily. Ye Bot Sirf Owner k Liye h. Mujhe Aap logo ko Hasane k liye banya gya h Toh Muh Ladkaye Mat Rakkha Karo. Har Waqt Haste Raho.", threadID);
   };

  if ((event.body.toLowerCase() == "bot admin") || (event.body.toLowerCase() == "bot ka admin kon ha")) {
     return api.sendMessage("He is Prince. He Gives his name Prince everywhare", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Ham se bakchodi") || (event.body.toLowerCase() == "malik se backchodi") || (event.body.toLowerCase() == "malkin se bakchodi") || (event.body.toLowerCase() == "malkin se backchodi")) {
     return api.sendMessage("srry maaf kr do ab nhi kruga 🥺🙏", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Asslamu alaikum") || (event.body.toLowerCase() == "Aslamu alaikum")) {
    return api.sendMessage("️ Waalaikum asslam 😇", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
   ...
   if ((event.body.toLowerCase() == "koi pyar nahi") || (event.body.toLowerCase() == "koi pyar nahi") || (event.body.toLowerCase() == "koi pyar nhi karta")) {
   ...
   if ((event.body.toLowerCase() == "kaise ho") || (event.body.toLowerCase() == "kaise ho") || (event.body.toLowerCase() == "kese ho ji") || (event.body.toLowerCase() == "how are you") || (event.body.toLowerCase() == "how are you?")) {
     return api.sendMessage("M Tabhi Accha hota hu, Jab Apko Hasta Huye Dekhta hu☺️", threadID);
   };

   if ((event.body.toLowerCase() == "Sana") || (event.body.toLowerCase() == "Sana")) {
     return api.sendMessage("Bare log ko mat bulao busy hai bare log <3", threadID);
   };
  ...
  if((event.body.toLowerCase() == "Prince") || (event.body.toLowerCase() == "Prince")) {
     return api.sendMessage("mera owner prince hai chal ab jaan gya na nikal apni buri sakal leke", threadID);
   };
  
  if ((event.body.toLowerCase() == "Nikal") || (event.body.toLowerCase() == "Nikal")) {
  ...
  if ((event.body.toLowerCase() == "prince") || (event.body.toLowerCase() == "ami diya") || (event.body.toLowerCase() == "main amrita") || (event.body.toLowerCase() == "main priyansh") || (event.body.toLowerCase() == "main diya")) {
